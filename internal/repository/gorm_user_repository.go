// G:\go_internist\internal\repository\gorm_user_repository.go
package repository
...
// Export a standard error for not found
...
// FindByUsernameOrPhone finds a user by either their username or phone number
...
// FindByPhoneAndStatus finds a user with a specific phone number and status
...
// ResetFailedAttempts resets lockout fields for a user after successful login
...
// UpdateCharacterBalance updates a user's character balance
...
// handleFindError is a helper to reduce repetitive error handling code
...
// Add this method to your gormUserRepository implementation
