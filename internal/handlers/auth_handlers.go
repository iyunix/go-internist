...
// Register registers a new user after validating input and sends verification SMS.
...
// VerifySMS verifies the code sent via SMS and activates the user.
...
// ResendSMS resends the verification SMS code.
...
// Login authenticates the user and sets the JWT cookie.
func (h *AuthHandler) Login(w http.ResponseWriter, r *http.Request) {
	...
	// Secure cookie with Proper Flags
...
// GetUserCreditHandler returns the user's credit and total credits info.
...
// Helper function to generate a 6-digit secure code.
...
// Validates username, phone, and password input with regex and length checks.
...
// Converts map[string]string to map[string]interface{} for template rendering.
